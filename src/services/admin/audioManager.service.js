...
exports.createFolder = async ({ name, description, parent_id }) => {
    ...
    return await worker.post(`/audio-manager/audio-folders`, {
        name,
...
exports.updateFolder = async (id, data) => {
    return await worker.put(
        `/audio-manager/audio-folders/${id}`,
        data
    );
};
